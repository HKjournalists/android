...
public class PartnerSignerUtil {
	...
	public static PublicKey getPublicKey(String key) {
		try {
			byte[] keyBytes = (Base64.decodeBase64(key.getBytes("GBK")));
	...
	public static boolean verify(byte[] data, String sign, PublicKey pubKey) {
		try {
			...
			signature.update(data);
			return signature.verify(Base64.decodeBase64(sign.getBytes("GBK")));
		} catch (Exception e) {
			return false;
		}
	}
	...
	//
	// PKCS8Generator sk = new PKCS8Generator(ygPrivate);
	//
