...
public class BaoxianInformalReport {
    private String id;

    private String baoxianIntentId;

    private String baoxianUnderwritingRequestId;
    ...
    public void setBaoxianIntentId(String baoxianIntentId) {
        this.baoxianIntentId = baoxianIntentId == null ? null : baoxianIntentId.trim();
    }

    public String getBaoxianUnderwritingRequestId() {
        return baoxianUnderwritingRequestId;
    }

    public void setBaoxianUnderwritingRequestId(String baoxianUnderwritingRequestId) {
        this.baoxianUnderwritingRequestId = baoxianUnderwritingRequestId == null ? null : baoxianUnderwritingRequestId.trim();
    }
    ...
    public void setBaoxianCompanyCode(String baoxianCompanyCode) {
        this.baoxianCompanyCode = baoxianCompanyCode == null ? null : baoxianCompanyCode.trim();
    }
    ...
    public void setBaoxianCompanyName(String baoxianCompanyName) {
        this.baoxianCompanyName = baoxianCompanyName == null ? null : baoxianCompanyName.trim();
    }
    ...
    public void setMainQuoteId(String mainQuoteId) {
        this.mainQuoteId = mainQuoteId == null ? null : mainQuoteId.trim();
    }
    ...
    public void setBaoxianCompanyPic(String baoxianCompanyPic) {
        this.baoxianCompanyPic = baoxianCompanyPic == null ? null : baoxianCompanyPic.trim();
    }
}