...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		case PULL_FROM_START:
			inAnimResId = getResources().getIdentifier("slide_in_from_top",
					"anim", context.getPackageName());
			outAnimResId = getResources().getIdentifier("slide_out_to_top",
					"anim", context.getPackageName());
			setBackgroundResource(getResources().getIdentifier(
					"indicator_bg_top", "drawable", context.getPackageName()));
			break;
		}
