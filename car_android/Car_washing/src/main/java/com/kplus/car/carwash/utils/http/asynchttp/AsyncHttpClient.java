...
package com.kplus.car.carwash.utils.http.asynchttp;
...
public class AsyncHttpClient {
   ...
   /**
    ...
    // Private stuff
    protected void sendRequest(final DefaultHttpClient client, final HttpContext httpContext, final HttpUriRequest uriRequest, final String contentType, final AsyncHttpResponseHandler responseHandler, final Context context) {
    	if(contentType != null) {
